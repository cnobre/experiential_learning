    ...
    drawChart() {
        ...
        if (length < 100) {
            ...
            d3.csv(data).then(function (data) {
                ...
                var rectHeight = length / 5.5 - margin.top;
                var rectY = height - rectHeight -60 ;
                ...
                var textY = height - rectHeight -18; 

                svg.append("text").attr("x", 0).attr("y", textY).text("4%").style("font-weight", "bold").attr("class", "legend-value");
                svg.append("text").attr("x", length / 20).attr("y", textY).text("6%").style("font-weight", "bold").attr("class", "legend-value");
                svg.append("text").attr("x", length / 10).attr("y", textY).text("8%").style("font-weight", "bold").attr("class", "legend-value");
                svg.append("text").attr("x", length / 7).attr("y", textY).text("10%").style("font-weight", "bold").attr("class", "legend-value");
                svg.append("text").attr("x", length / 5).attr("y", textY).text("12%").style("font-weight", "bold").attr("class", "legend-value");
